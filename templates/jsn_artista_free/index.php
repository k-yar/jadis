	...
	?>
		<div id="jsn-header">
			<div id="jsn-header-inner" class="clearafter">
				...
				<?php
					if ($this->helper->countPositions('mainmenu')) {
				?>
		...
		?>
            ...
            <div id="jsn-content-top-below">
                <div id="jsn-pos-content-top-below" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $jsnutils->countModules('content-top-below'); ?> row-fluid">
                    <jdoc:include type="modules" name="content-top-below" style="jsnmodule" class="jsn-roundedbox" columnClass="span<?php echo ceil(12 / $jsnutils->countModules('content-top-below')); ?>" />
                </div>
            </div>
            <?php
                }
            ...
            <div id="jsn-content-top-over">
                <div id="jsn-pos-content-top-over" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $jsnutils->countModules('content-top-over'); ?> row-fluid">
                    <jdoc:include type="modules" name="content-top-over" style="jsnmodule" class="jsn-roundedbox" columnClass="span<?php echo ceil(12 / $jsnutils->countModules('content-top-over')); ?>" />
                </div>
            </div>
            <?php
                }
		...
		<?php
        /*====== Show modules in position "content-bottom-above" ======*/
        if ($jsnutils->countModules('content-bottom-above') > 0) {
        ?>
        <div id="jsn-content-bottom-above">
            <div id="jsn-pos-content-bottom-above" class="jsn-modulescontainer row-fluid">
                <jdoc:include type="modules" name="content-bottom-above" style="jsnmodule" class="jsn-roundedbox" />
            </div>
        </div>
        <?php
            }
        ...
        /*====== Show modules in position "content-bottom-under" ======*/
        if ($jsnutils->countModules('content-bottom-under') > 0) {
        ?>
        <div id="jsn-content-bottom-under">
            <div id="jsn-pos-content-bottom-under" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $jsnutils->countModules('content-bottom-above'); ?> row-fluid">
                <jdoc:include type="modules" name="content-bottom-under" style="jsnmodule" class="jsn-roundedbox" columnClass="span<?php echo ceil(12 / $jsnutils->countModules('content-bottom-under')); ?>" />
            </div>
        </div>
        <?php
            }
		...
		?>
			<div id="jsn-usermodules3"><div id="jsn-usermodules3-inner" class="jsn-modulescontainer jsn-modulescontainer<?php echo $this->helper->countPositions('user5', 'user6', 'user7'); ?> row-fluid">
		<?php
		...
		<?php
			...
			$positionCount = $this->helper->countPositions('footer', 'bottom');
				$grid_suffix = $positionCount;
		?>
			<div id="jsn-footer" class="jsn-modulescontainer jsn-modulescontainer<?php echo $grid_suffix; ?> row-fluid"><div id="jsn-footer-inner">
				<?php
