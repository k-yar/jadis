...
define("LAFC_FORMS_PATH",        JPATH_ROOT.'/administrator/components/com_flexicontact/forms');
define("LAFC_SITE_IMAGES_PATH",  JPATH_SITE.'/components/com_flexicontact/images');
define("LAFC_SITE_IMAGES_URL",   JURI::root(true).'/components/com_flexicontact/images/');
...
static function renderFieldSet($form, $fieldset, $data)
{
    ...
    foreach ($fields as $field)
        ...
        if ($desc != '')
            $html .= ' '.self::make_info(JText::_($desc),$link);
