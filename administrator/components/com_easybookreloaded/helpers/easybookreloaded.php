...
class EasybookReloadedHelper
{
	...
	{
		JHtmlSidebar::addEntry(JText::_('COM_EASYBOOKRELOADED_SUBMENU_ENTRIES'), 'index.php?option=com_easybookreloaded', $view_name == 'easybookreloaded');
		JHtmlSidebar::addEntry(JText::_('COM_EASYBOOKRELOADED_SUBMENU_GB'), 'index.php?option=com_easybookreloaded&amp;task=gb', $view_name == 'gb');
		JHtmlSidebar::addEntry(JText::_('COM_EASYBOOKRELOADED_SUBMENU_BADWORDFILTER'), 'index.php?option=com_easybookreloaded&amp;controller=badwords', $view_name == 'badwords');
		JHtmlSidebar::addEntry(JText::_('COM_EASYBOOKRELOADED_SUBMENU_ABOUT'), 'index.php?option=com_easybookreloaded&amp;task=about', $view_name == 'about');
	}
